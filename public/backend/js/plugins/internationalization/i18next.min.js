            ...
            return (
                (e.prototype.init = function () {
                    ...
                    arguments[1] &&
                        ...
                        (this.escape =
                            (t.interpolation && t.interpolation.escape) || l)),
                        t.interpolation ||
        ...
        T = (function (t) {
            function e(n, o, r) {
                ...
                return (
                    ...
                    (s.state = {}),
                    (s.queue = []),
                    s.backend && s.init && s.init(r, i.backend, i),
                    s
                );
            }
            return (
                ...
                (e.prototype.reload = function (t, e) {
                    ...
                    var o = y({}, this.options, this.options.backend);
                    "string" == typeof t &&
                        (t = this.languageUtils.toResolveHierarchy(t)),
                        "string" == typeof e && (e = [e]),
                        o.allowMultiLoading && this.readMulti
                            ? this.read(
                                  t,
                                  e,
                                  "readMulti",
                ...
                if (
                    ...
                    (i.logger = O),
                        ...
                        (i.pluralResolver = new M(r, {
                            ...
                            simplifyPluralSuffix: this.options
